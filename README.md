...
- **Linux**: Archiv entpacken (legt ein Verzeichnis `dictUSB/` an),
  `./dictUSB/dictUSB` starten (GTK 3 muss installiert sein). Der
  Starter legt automatisch den `.desktop`-Eintrag fürs Dock-Icon an
  und startet die App — Details in `app/README.md`.
